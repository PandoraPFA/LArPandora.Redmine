...
/// This singleton class encapsulates the calculations associated with
...
namespace sim {
  ...
  LArVoxelCalculator::LArVoxelCalculator(fhicl::ParameterSet const& pset, art::ActivityRegistry &reg) 
  {
    ...
    // not really sure what these do at the moment - comment them out until needed
    // Register for callbacks.
//     reg.watchPostBeginJob    (this, &LArVoxelCalculator::postBeginJob);
//     reg.watchPostEndJob      (this, &LArVoxelCalculator::postEndJob);
//     reg.watchPreSource       (this, &LArVoxelCalculator::preSource);
//     reg.watchPostSource      (this, &LArVoxelCalculator::postSource);
//     reg.watchPreProcessEvent (this, &LArVoxelCalculator::preProcessEvent);
//     reg.watchPostProcessEvent(this, &LArVoxelCalculator::postProcessEvent
