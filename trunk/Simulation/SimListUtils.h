...
namespace sim{
    ...
    public:
      ...
      static sim::ParticleList     GetParticleList    (const art::Event& evt, std::string moduleLabel);
      static sim::PMTHitCollection GetPMTHitCollection(const art::Event& evt, std::string moduleLabel);
