////////////////////////////////////////////////////////////////////////
/// \file  EmEveIdCalculator.cxx
/// \brief Example routine for calculating the "ultimate e-m mother" of a particle in a simulated event.
///
/// \version $Id: EmEveIdCalculator.cxx,v 1.1 2010/05/13 16:12:20 seligman Exp $
...
namespace sim {
  ...
  int EmEveIdCalculator::DoCalculateEveId( const int trackID )
  {
    ...
    for(sim::ParticleHistory::const_reverse_iterator i = particleHistory.rbegin();
	i != particleHistory.rend(); ++i){
