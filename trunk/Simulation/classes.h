...
namespace {
 ...
 util::VectorMap<int,double> dummy;
...
template class art::Wrapper< std::vector<sim::Particle>     >;
template class art::Wrapper< std::vector<sim::SimChannel>   >;
template class art::Wrapper< std::vector<sim::PMTHit>       >;
template class art::Wrapper< std::vector<sim::PMTPhoton>    >;
template class art::Wrapper< std::vector<sim::PhotonLibraryParameters> >;
