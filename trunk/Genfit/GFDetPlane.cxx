...
genf::GFDetPlane::GFDetPlane(GFAbsFinitePlane* finite) 
  :fFinitePlane(finite)
{
  static TRandom3 r(0);
  fO.SetXYZ(0.,0.,0.);
...
void 
genf::GFDetPlane::set(const TVector3& o,
	      const TVector3& u,
	      const TVector3& v)
{
  fO=o;fU=u;fV=v;
...
void 
genf::GFDetPlane::setO(const TVector3& o)
{
  fO=o;
  sane();
}
void 
genf::GFDetPlane::setO(double X,double Y,double Z)
{
  fO.SetXYZ(X,Y,Z);
  sane();
}
...
void 
genf::GFDetPlane::setU(const TVector3& u)
{
  fU=u;
  sane();
}
void 
genf::GFDetPlane::setU(double X,double Y,double Z)
{
  fU.SetXYZ(X,Y,Z);
  sane();
}
...
void 
genf::GFDetPlane::setV(const TVector3& v)
{
  fV=v;
  sane();
}
void 
genf::GFDetPlane::setV(double X,double Y,double Z)
{
  fV.SetXYZ(X,Y,Z);
  sane();
}
void 
genf::GFDetPlane::setUV(const TVector3& u,const TVector3& v)
{
  fU=u;
  fV=v;
  sane();
...
TVector3
genf::GFDetPlane::getNormal() const
{
...
void
genf::GFDetPlane::setNormal(double X,double Y,double Z){
  TVector3 N(X,Y,Z);
  setNormal(N);
}
void
genf::GFDetPlane::setNormal(TVector3 n){
  n.SetMag(1.);
  if( fabs(n.X()) > 0.1 ){
...
TVector2
genf::GFDetPlane::project(const TVector3& x)const
{
  Double_t xfU=fU*x;
  Double_t xfV=fV*x;
...
TVector2 
genf::GFDetPlane::LabToPlane(const TVector3& x)const
{
  TVector3 d=x-fO;
  return project(d);
}
...
TVector3
genf::GFDetPlane::toLab(const TVector2& x)const
{
  TVector3 d(fO);
  d+=x.X()*fU;
  d+=x.Y()*fV;
...
TVector3 
genf::GFDetPlane::dist(const TVector3& x)const
{
...
void genf::GFDetPlane::getGraphics(double mesh, double length, TPolyMarker3D **pl,TPolyLine3D** plLine, TPolyLine3D **u, TPolyLine3D **v, TPolyLine3D**n){
