...
double
genf::GeaneTrackRep2::extrapolate(const GFDetPlane& pl, 
...
void
genf::GeaneTrackRep2::extrapolateToPoint(const TVector3& pos,
				 TVector3& poca,
				 TVector3& normVec){
...
void 
genf::GeaneTrackRep2::extrapolateToLine(const TVector3& point1,
...
void genf::GeaneTrackRep2::poca2Line(const TVector3& extr1,const TVector3& extr2,const TVector3& point,TVector3& result){
...
void genf::GeaneTrackRep2::pocaLine2Line(const TVector3& point1,const TVector3& line1,const TVector3& point2, const TVector3& line2,TVector3& result1,TVector3& result2){
  TVector3 l(line1);
  l.SetMag(1.);
  TVector3 k(line2);
  k.SetMag(1.);
...
TVector3 
genf::GeaneTrackRep2::getPos(const GFDetPlane& pl)
{
...
TVector3 
genf::GeaneTrackRep2::getMom(const GFDetPlane& pl)
{
  TMatrixT<Double_t> statePred(fState);
  if(pl!=fRefPlane)extrapolate(pl,statePred);
  //pl.Print();
...
void
genf::GeaneTrackRep2::getPosMom(const GFDetPlane& pl,TVector3& pos, TVector3& mom)
{
  TMatrixT<Double_t> statePred(fState);
  if(pl!=fRefPlane)extrapolate(pl,statePred);
