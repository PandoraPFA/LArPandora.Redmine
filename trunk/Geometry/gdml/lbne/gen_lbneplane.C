...
//   //the wires in the middle of the plane
  ...
  for(int i = 0; i < ncw; ++i){
    ...
    //    of << "     <position name=" << TString::Format("\"posTPCWire%d\" unit=\"cm\" y=\"-0.5*kTPCWidth+(0.5*%d + %d+1)*kTPCWireXPitch*kCos60/kCos30\" z=\"-0.5*kTPCWirePlaneLength+kTPCWireXPitch*(0.5*%d)\" x=\"0\"/> ", nsw+i, nsw, i, nsw)                                                                  << endl;
    of << "     <position name=" << TString::Format("\"posTPCWire%d\" unit=\"cm\" y=\"-0.5*kTPCWidth+(0.5*%d + %d+1)*kTPCWireXPitch*kCos60/kCos30\" z=\"0\" x=\"0\"/> ", nsw+i, nsw, i, nsw)      << endl;
    of << "     <rotationref ref=\"rPlus150AboutX\"/>"                       << endl;
    of << "    </physvol> "                                                  << endl;
  }
