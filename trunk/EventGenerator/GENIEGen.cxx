////////////////////////////////////////////////////////////////////////
// $Id: GENIEGen.cxx,v 1.4 2010/04/27 19:48:46 brebel Exp $
//
//
...
namespace evgen{
  ...
  void GENIEGen::beginJob(){
    ...
    std::cout << "detector dimensions are " << x << "x" << y << "x" << z << std::endl; 
  ...
  void GENIEGen::produce(art::Event& evt)
  {
	...
	LOG_DEBUG("GENIEGen") << "no events made for this spill - continue on until we get a spill with events";
	break;
      }
