////////////////////////////////////////////////////////////////////////
// $Id: CalWireMicroBooNE.cxx,v 1.36 2010/09/15  bpage Exp $
//
...
// LArSoft includes
#include "CalData/CalWireMicroBooNE.h"
...
namespace caldata{
  ...
  {  
    ...
    LOG_DEBUG("CalWireMicroBooNE") << "CalWireMicroBooNE_module: Opening  Electronics Response File: " 
				   << fResponseFile.c_str();
    
    TFile f(fResponseFile.c_str());
    if( f.IsZombie() )
      mf::LogWarning("CalWireMicroBooNE") << "Cannot open response file " 
					  << fResponseFile.c_str();
  ...
  {      
	...
	if(sigtype == geo::kInduction)
	  ...
	  throw cet::exception("CalWireMicroBooNE") << "Bad signal type = " << sigtype << "\n";
