...
namespace detsim{
  ...
  //-------------------------------------------------
  void SimWireMicroBooNE::ConvoluteResponseFunctions()
  {
  ...
  //-------------------------------------------------
  void SimWireMicroBooNE::GenNoise(std::vector<double>& noise)
  {
    art::ServiceHandle<art::RandomNumberGenerator> rng;
    CLHEP::HepRandomEngine &engine = rng->getEngine();
    CLHEP::RandFlat flat(engine);
  ...
  //-------------------------------------------------
  void SimWireMicroBooNE::SetFieldResponse()
  {
    art::ServiceHandle<geo::Geometry> geo;
  ...
  //-------------------------------------------------
  void SimWireMicroBooNE::SetElectResponse()
  {
    art::ServiceHandle<geo::Geometry> geo;
