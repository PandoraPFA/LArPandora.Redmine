/**
 *  @file   larpandora/LArPandoraShowers/PCAShowerParticleBuildingAlgorithm.h
 *
 ...
 */
class PCAShowerParticleBuildingAlgorithm : public lar_content::CustomParticleCreationAlgorithm
{
public:
    /**
