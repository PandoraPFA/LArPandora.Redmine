...
void PFParticleTrackAna::analyze(const art::Event &evt)
{
    ...
    const detinfo::DetectorProperties* theDetector = lar::providerFrom<detinfo::DetectorPropertiesService>();
    //   const detinfo::LArProperties* theLiquidArgon = lar::providerFrom<detinfo::LArPropertiesService>();
