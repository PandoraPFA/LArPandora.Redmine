...
template void LArPandoraHelper::GetAssociatedHits(const art::Event &, const std::string &, const std::vector<art::Ptr<recob::SpacePoint>> &, HitVector &, const pandora::IntVector* const);
