...
public:
     ...
     */
    LArPandoraEvent (const LArPandoraEvent & event, PFParticleVector & selectedPFParticles);
     ...
     */
    LArPandoraEvent FilterByCRTag(const bool shouldProduceNeutrinos, const std::string & tagProducerLabel);
...
private:
     ...
     */
    template < class T >
    void GetCollection(const Labels::LabelType & inputLabel, art::Handle< std::vector< T > > & outputHandle, std::vector< art::Ptr< T > > & outputCollection);
    ...
    void GetAssociationMap(const Labels::LabelType & inputLabel, art::Handle< std::vector< T > > & inputHandleT, std::map< art::Ptr< T >, std::vector< art::Ptr< U > > > & outputAssociationMap);
     ...
     */
    void GetPrimaryPFParticles(PFParticleVector & primaryPFParticles);
     ...
     */
    void GetFilteredParticlesByPdgCode(const bool shouldProduceNeutrinos, const PFParticleVector & inputPFParticles, PFParticleVector & outputPFParticles);
     ...
     *  @param  filteredPFParticles     output vector of filtered PFParticles
     */
    void GetFilteredParticlesByCRTag(const bool shouldProduceNeutrinos, const std::string & tagProducerLabel, const PFParticleVector & inputPFParticles, PFParticleVector & outputPFParticles);
     ...
     */
    void GetFilteredHierarchyMap(const PFParticleVector & filteredParticles, const PFParticlesToPFParticles & unfilteredPFParticleDaughterMap, PFParticlesToPFParticles & outputPFParticleDaughterMap);
     ...
     */
    void GetDownstreamPFParticles(const PFParticleVector & inputPFParticles, PFParticleVector & downstreamPFParticles);
     ...
     */
    void GetDownstreamPFParticles(const art::Ptr< recob::PFParticle > & part, PFParticleVector & downstreamPFParticles);
     ...
     */
    template < class T, class U >
    void CollectAssociated(const art::Ptr< T > & anObject, const std::map< art::Ptr< T >, std::vector< art::Ptr< U > > > & associationTtoU, std::vector< art::Ptr< U > > & associatedU);
     ...
     */
    template < class T, class U >
    void GetFilteredAssociationMap(const std::vector< art::Ptr< T > > & collectionT, const std::vector< art::Ptr< U > > & collectionU, const std::map< art::Ptr< T >, std::vector< art::Ptr< U > > > & inputAssociationTtoU, std::map< art::Ptr< T >, std::vector< art::Ptr< U > > > & outputAssociationTtoU);
     ...
     *  @param  collection  the collection to write
     */
    void WriteCollection(const PFParticleVector & collection);
     ...
     */
    template < class T, class U >
    void WriteAssociation(const std::map< art::Ptr< T >, std::vector< art::Ptr< U > > > & associationMap, const std::vector< art::Ptr< T > > & collectionT, const std::vector< art::Ptr< U > > & collectionU, const bool thisProducesU = true);
     ...
     */
    void MergePFParticleToOriginIdMap(std::map< art::Ptr< recob::PFParticle >, unsigned int > & mapToMerge, const std::map< art::Ptr< recob::PFParticle >, unsigned int > & mapToAdd);
     ...
     */
    template < class T >
    void MergeCollection(std::vector< art::Ptr< T > > & collectionToMerge, std::vector< art::Ptr< T > > & collection);
...
template < class T >
inline void LArPandoraEvent::GetCollection(const Labels::LabelType & inputLabel, art::Handle< std::vector< T > > & outputHandle, std::vector< art::Ptr< T > > & outputCollection)
{
...
template < class T, class U >
inline void LArPandoraEvent::GetAssociationMap(const Labels::LabelType & inputLabel, art::Handle< std::vector< T > > & inputHandleT, std::map< art::Ptr< T >, std::vector< art::Ptr< U > > > & outputAssociationMap)
{
...
template < class T, class U >
inline void LArPandoraEvent::CollectAssociated(const art::Ptr< T > & anObject, const std::map< art::Ptr< T >, std::vector< art::Ptr< U > > > & associationTtoU, std::vector< art::Ptr< U > > & associatedU)
{
...
template < class T, class U >
inline void LArPandoraEvent::GetFilteredAssociationMap(const std::vector< art::Ptr< T > > & collectionT, const std::vector< art::Ptr< U > > & collectionU, const std::map< art::Ptr< T >, std::vector< art::Ptr< U > > > & inputAssociationTtoU, std::map< art::Ptr< T >, std::vector< art::Ptr< U > > > & outputAssociationTtoU)
{
...
inline void LArPandoraEvent::WriteCollection(const PFParticleVector & collection)
{
...
template < class T >
inline void LArPandoraEvent::MergeCollection(std::vector< art::Ptr< T > > & collectionToMerge, std::vector< art::Ptr< T > > & collection)
{
...
template < class T, class U >
inline void LArPandoraEvent::MergeAssociation(std::map< art::Ptr< T >, std::vector< art::Ptr< U > > > & associationToMerge, std::map< art::Ptr< T >, std::vector< art::Ptr< U > > > & association)
{
