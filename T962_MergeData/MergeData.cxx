...
namespace merge{
  ...
  //-------------------------------------------------
  MergeData::MergeData(fhicl::ParameterSet const& pset) : 
  
    fdaq_modulelabel(pset.get< std::string >("daq")),
    //file(pset.get< std::string >("file")),
  ...
  //-------------------------------------------------
  void MergeData::produce(art::Event& evt)
  {
  ...
  void MergeData::MergeBeam(raw::BeamInfo& beam)
  {
    ...
    art::Timestamp  timestamp=fdaq->GetTimeStamp();
