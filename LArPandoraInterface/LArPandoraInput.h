...
public:
     ...
     *
     *  @param  pILArPandora the address of the lar pandora
     ...
     */
    static void CreatePandoraHits2D(const ILArPandora *const pILArPandora, const pandora::Pandora *const pPrimaryPandora,
     ...
     */
    static void CreatePandoraHits3D(const ILArPandora *const pILArPandora, const pandora::Pandora *const pPrimaryPandora,
     ...
     */
    static void CreatePandoraMCParticles(const ILArPandora *const pILArPandora, const pandora::Pandora *const pPrimaryPandora,
     ...
     */
    static void CreatePandoraMCParticles2D(const ILArPandora *const pILArPandora, const pandora::Pandora *const pPrimaryPandora,
     ...
     */
    static void CreatePandoraMCLinks2D(const ILArPandora *const pILArPandora, const pandora::Pandora *const pPrimaryPandora,
...
private:
     ...
     */
    static void GetTrueStartAndEndPoints(const ILArPandora *const pILArPandora, const int volumeID, const art::Ptr<simb::MCParticle> &particle,
        int &startT, int &endT);
